...
var pitchFrequency = function(pitch) {
  var adjPitch = pitch.charAt(0).toUpperCase() + pitch.slice(1)
  var normalizedPitch =  ENHARMONIC_EQUIVALENTS[adjPitch];
  console.log("pitchFrequency() normalizedPitch " + normalizedPitch);
